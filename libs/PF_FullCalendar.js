...
( function( $, mw, pf ) {
	...
	$( '.pfFullCalendarJS' ).each( function() {
		...
		const deleteButton = '<button id="event_delete" class = "delete-event-button" name="data" type="button" >' + mw.html.escape( mw.msg('pf-calendar-deleteevent') ) + '</button>';
		const createButton = '<button id="form_submit" class = "submit-event-button" name="data" type="button" >' + mw.html.escape( mw.msg('pf-calendar-createevent') ) + '</button>';
		const updateButton = '<button id="form_submit" class = "submit-event-button" name="data" type="button" >' + mw.html.escape( mw.msg('pf-calendar-updateevent') ) + '</button>';
		popup += formHtml;
